...
class AddNewTestInsuranceAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply(): void
    {
        ...
        $attributeCode = 'new_test_product_insurance_attribute';
        $attributeLabel = 'NEInsurance';
        ...
        $categorySetup->addAttribute(
            ...
            [
                ...
                'frontend' => 'ArseniyInk\TaskTwo\Model\Product\Attribute\Frontend\Insurance',
                'backend' => 'ArseniyInk\TaskTwo\Model\Product\Attribute\Backend\Insurance',
